...
txt = '''The Zen of Python, by Tim Peters. Beautiful is better than ugly. Explicit is better than implicit.
...
def filter_(i):
    if 'p' in i or 'P' in i:
        return True
    return False
p = filter(filter_, list1)
plist = list(p)
print("Отфильтрованный список:", plist)
